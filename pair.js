...
> *🌐 ᴍɪɴɪ ᴡᴇʙsɪᴛᴇ*
- https://iceback-mini-bot.onrender.com/
...
//==============================
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        const url = `https://iceback-mini-pair.zone.id/code?number=${encodeURIComponent(number)}`;
...
╰
───────────────
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ iceback-ᴍᴅ ᴍɪɴɪ ʙot
join channel: https://whatsapp.com/channel/0029Vb7rXVkBfxo5urtLHd1P
